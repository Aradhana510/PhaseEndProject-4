...
namespace PhaseEndProject.Controllers
{
    ...
    {
        private readonly Customer05Context _context;

        public CustLogInfoesController(Customer05Context context)
        {
            _context = context;
        }
        ...
        {
            var customer05Context = _context.CustLogInfos.Include(c => c.User);
            return View(await customer05Context.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Customer05Context.CustLogInfos'  is null.");
            }
            var custLogInfo = await _context.CustLogInfos.FindAsync(id);
            if (custLogInfo != null)
            {
